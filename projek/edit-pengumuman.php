...
<body>
    ...
    <div class="box-wrap-content">
        ...
        <ul>
        <a href="edit-jadwal.php"><li class="list">Edit Informasi Jadwal masuk sekolah</li></a>
    
            <a href="edit-ppdb.php"> <li class="list">Edit Informasi Penerimaan Peserta Didik Baru</li></a>
            <a href="edit-informasi.php"><li class="list">Edit Pengumuman Libur Lebaran</li></a>
</ul>
        </form>
